...
void CUITradeWnd::SetCurrentItem(CUICellItem* itm)
{
	...
	if(itm && m_uidata->UIItemInfo.UICost){
		...
		sprintf_s				(str, "%d UAH", m_pOthersTrade->GetItemPrice(CurrentIItem(), bBuying) );
